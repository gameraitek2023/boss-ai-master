                  ...
                  child: Padding(
                    ...
                    child: FutureBuilder<List<MobileAppsRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<MobileAppsRow> listViewMobileAppsRowList =
                            snapshot.data!;
                        return ListView.builder(
                          ...
                          itemCount: listViewMobileAppsRowList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewMobileAppsRow =
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    'AImodelsDetails',
                                    queryParameters: {
                                      'mobile01': serializeParam(
                                        listViewMobileAppsRow,
                  ...
                  children: [
                    Align(
                      ...
                      child: TabBar(
                        ...
                        indicatorColor: Color(0x7BFF1A5B),
                        indicatorWeight: 3.0,
                        tabs: [
                          Tab(
                            text: 'Benefits: Free Mobile Apps for you!',
                          ),
                        ],
