        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'aImodelsDetails',
              builder: (context, params) => AImodelsDetailsWidget(
                mobile01: params.getParam<MobileAppsRow>(
                    'mobile01', ParamType.SupabaseRow),
              ),
            ),
            FFRoute(
              name: 'Webview',
              ...
              builder: (context, params) => WebviewWidget(
                link1: params.getParam('link1', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'AIappview',
              path: 'aIappview',
              builder: (context, params) => AIappviewWidget(
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: Color(0xFF020519),
                  child: Center(
                    child: Image.asset(
                      'assets/images/aed11d6975231b91c8e992c02b8376da.gif',
                      width: 250.0,
                      height: 250.0,
                      fit: BoxFit.cover,
                    ),
